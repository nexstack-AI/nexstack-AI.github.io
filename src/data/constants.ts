...
export const EXPERIENCE: Experience[] = [
  {
    ...
    company: "重庆锐云科技有限公司",
    description: [
      "9 年深耕前端开发，负责 PC 端、可视化大屏、移动端、小程序、H5 等多端页面研发",
      "主导 React/Taro/Vite 技术选型与前端架构搭建，自建钩子封装公共逻辑",
      "累计主导 30+ 个项目交付，核心项目云置业三端合一，稳定迭代 6 年以上",
      "带领高尔夫项目团队（3-5人），负责架构设计、任务分配与代码审查",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.TS,
